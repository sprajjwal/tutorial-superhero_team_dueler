...
def test_armor():
    ...
    for damage in range(0, 500):
        defense = armor.defend(damage)
...
def test_hero_defense_mean_value():
    ...
    total_attack = 0
    accepted_window = 400
    for damage in range(iterations):
        attack_value = athena.defend(damage)
...
def test_hero_defense_standard_deviation():
    ...
    total_defend = 0
    number_tests = 100
    for damage in range(number_tests):
        defense = willow_waffle.defend(damage)
